...
{   
    let newRestaurant=new Restaurant(
        {   name : req.body.name,
            restaurant_image : req.file.buffer,
	...
	try{
        ...
        // logic for avoiding duplicate entries   
            ...
            //here our data will contains an array of all elements which got matched.
                ...
                {
                    newRestaurant.save((err,obj)=>{
                        if(err)
                        {   
                            res.json({msg:"Invalid data entered",error:err});
                        }else
                        {
                            res.json({msg:"Restaurant Saved Successfully",rest_id:obj._id});
                        }
                    });
                }
            });
